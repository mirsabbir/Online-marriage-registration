...
<div class="card">
    ...
    @csrf
    @method('PUT')
    <div class="card-header"><strong>Edit National ID</strong><small> Form</small></div>
    <div class="card-body card-block">
        <div class="form-group"><label for="name" class=" form-control-label">Name</label><input type="text" value="{{$nid->name_eng}}" id="name" placeholder="Enter your name " class="form-control" name="name"></div>
        <div class="form-group"><label for="নাম (বাংলায় )" class=" form-control-label">নাম (বাংলায় )</label><input type="text" value="{{$nid->name}}" id="নাম (বাংলায় )" placeholder="নাম (বাংলায় )" class="form-control" name="name_bng"></div>
        <div class="form-group"><label for="পিতার নাম (বাংলায় )" class=" form-control-label">পিতার নাম (বাংলায় )</label><input type="text" value="{{$nid->fathers_name}}" id="পিতার নাম (বাংলায় )" placeholder="পিতার নাম (বাংলায় )" class="form-control" name="fathers_name"></div>
        <div class="form-group"><label for="মাতার নাম (বাংলায় )" class=" form-control-label">মাতার নাম (বাংলায় )</label><input type="text" value="{{$nid->mothers_name}}" id="মাতার নাম (বাংলায় )" placeholder="মাতার নাম (বাংলায় )" class="form-control" name="mothers_name"></div>
        ...
        <div class="form-group"><label for="country" class=" form-control-label">জন্ম তারিখ </label><input type="text" value="{{$nid->dob}}" id="country" placeholder="YYYY-MM-DD" class="form-control" name="dob"></div>
        ...
        <div class="form-group"><label for="বিভাগ " class=" form-control-label">বিভাগ </label>
            <select name="division" id="" @change="loadDist" class="form-control">
                ...
                <option value="{{$div->bn_name}}" <?php print($div->bn_name==$nid->division? 'selected':'' ) ?>>{{$div->bn_name}}</option>
                @endforeach
            </select>
        </div>
...
@push('scripts')
    ...
    <script>
        let vm = new Vue({
            ...
            mounted(){
                this.dists.push({'bn_name':'{{$nid->district}}' });
                console.log(this.dists);
                this.upzs.push({'bn_name':'{{$nid->upozilla}}' });
            }
        })
    </script>
@endpush